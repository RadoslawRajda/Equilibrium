...
/// @dev Relays agent decisions into `AIGameMaster` logs. The core game contract no longer
///      exposes direct game-master balance mutation hooks; keep any balance-sync logic in a
///      separate auxiliary contract if needed.
